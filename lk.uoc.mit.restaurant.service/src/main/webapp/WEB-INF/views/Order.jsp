    ...
    <script type="text/javascript"
      ...
      <script>
           ...
           function initMap() {
             ...
             var chicago = {lat: 6.8860127, lng: 79.9033939};
             var indianapolis = {lat: 6.8860127, lng: 80.9033939};
    ...
    <table class="table table-striped">
           ...
           <c:forEach items="${orderList}" var="order">
                ...
                <tr>
                 ...
                 <td> <button onclick="initMap()" type="button" class="open-Dialog btn btn-info btn-md" data-toggle="modal"  data-target="#myModal">View Location</button></td>
               </tr>
